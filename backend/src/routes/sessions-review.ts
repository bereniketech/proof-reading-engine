...
import { reviewDocument } from '../services/reviewer.js';
...
export const sessionsReviewRouter = Router();

// GET /api/sessions/:id/review
sessionsReviewRouter.get(
  '/sessions/:id/review',
  async (req: Request, res: Response): Promise<void> => {
    ...
    try {
      const report = await reviewDocument(id, sections ?? []);
