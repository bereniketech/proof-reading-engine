...
import { detectClaims } from '../services/citation-detector.js';
...
export const sessionsCitationsRouter = Router();

// GET /api/sessions/:id/citations
sessionsCitationsRouter.get(
  '/sessions/:id/citations',
  async (req: Request, res: Response): Promise<void> => {
    ...
    try {
      const report = await detectClaims(id, sections ?? []);
